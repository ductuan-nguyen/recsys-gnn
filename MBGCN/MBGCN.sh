...
mode='train'
output_test='submits/2-rel-mf32-freeze-emb'
trained_mbgcn_model='/home/tuannd/MBGCN/output/ubc/ubc-MBGCN_lr3e-4-L1e-4-size32-lamb1-md0.1-nd0.1@rel2-mf32/model_epoch_10.pkl'
# lr_list=('3e-5')
# L2_list=('1e-5')
...
do
    ...
    do
        name=${dataset_name}-${model}_lr${lr}-L${L2}-size${embedding_size}-lamb${lamb}-md${md}-nd${nd}@3rel-mf64-freeze-emb-uu-add-item-user-feat-concat
